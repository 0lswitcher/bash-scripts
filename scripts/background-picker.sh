...
cleanup() {
  ...
  pkill -f "feh --title WallpaperPreview" 2>/dev/null
...
feh --title WallpaperPreview --geometry 1150x650+650+250 --scale-down --image-bg black --reload 1 --no-menus "$PREVIEW_IMG" &
FEH_PID=$!
